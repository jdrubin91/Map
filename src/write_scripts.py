...
def run(scriptdir, genomedir, bowtieindex, bowtieoptions, email):
    ...
    outfile.write("#SBATCH --output $SLURM_SUBMIT_DIR/e_and_o/\n")
    outfile.write("#SBATCH --error $SLURM_SUBMIT_DIR/e_and_o/\n")
    ...
    outfile.write("#!/bin/bash\n")
    outfile.write("#SBATCH -p long\n")
    outfile.write("#SBATCH --nodes=4\n")
    outfile.write("#SBATCH --ntasks=128\n")
    outfile.write("#SBATCH --mem=2000gb\n")
    ...
    outfile.write("samtools sort -m100000000000 ${outdir}${basename}.bam ${outdir}${basename}.sorted\n")
